...
> `https://github.com/sergeykeba-cell/n8n-ai-automation-leads/actions/workflows/ci.yml/badge.svg`
> once GitHub Actions runs for the first time.

<!--
  📸 Add a demo GIF/screenshot here — this is the single highest-impact
  addition for this README. Record: CSV upload → AI scoring → Telegram alert.
  Suggested tools: Kap (macOS), ScreenToGif (Windows), peek (Linux).
